...
import ImageGroup from '../widget/ImageGroup.jsx';
import Image from "../dependencies/Image/Image.jsx";
    ...
    return <>
        <div id="frame" style={{ width: "400px", height: '400px'}}>
            <ImageGroup>
                ...
                <Image objImg={objImg_2} isFullScreen={true} />
                <Image objImg={objImg_3} isFullScreen={true} />
                <Image objImg={objImg_4} isFullScreen={true} />
            </ImageGroup>
        </div>
